			...
			var smartActions = {
			    ...
			    userLogout: function ($this) {
					...
					$.SmartMessageBox({
						...
						content : $this.data('logout-msg') || "Вы можете улучшить свою безопасность после выхода из системы, закрыв этот открытый браузер",
						buttons : '[Нет][Да]'
		...
		if ($.fn.datepicker) {
			$('.datepicker').each(function() {
				...
				$this.datepicker({
                    ...
                    changeYear: true,
					yearRange: "-100:+0",
					//Ограничение даты рождения статически
					//maxDate: new Date('2014-01-31')
					//Ограничение даты сегодняшним днем
