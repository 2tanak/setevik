    ...
    <div>
        ...
        <div class="tabs-left">
            <ul class="nav nav-tabs tabs-left" id="demo-pill-nav">
                <li class="active">
                    <a href="#tab-r1" data-toggle="tab">Название</a>
                </li>
                <li>
                    <a href="#tab-r2" data-toggle="tab">Описание</a>
                </li>
                <li>
                    <a href="#tab-r3" data-toggle="tab">Файлы</a>
                </li>
                <li>
                    <a href="#tab-r4" data-toggle="tab">Активность</a>
                </li>
            </ul>
                    ...
                    <fieldset>
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input v-model="title" name="title" class="form-control" placeholder="Введите название">
                                </div>
                            </div>
                        </div>
                    </fieldset>
            ...
            <div class="text-center">
                ...
                <a href="/admin/sib/documents" class="btn btn-default">Отменить</a>
            </div>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            init: function () {
                ...
                th.editor = CKEDITOR.replace('ckeditor-detail', { height: '380px', startupFocus : true} );
            },
            refresh: function () {
                this.errors = '';
            ...
            save: function (callback) {
                ...
                if (th.documentId) {
                    ...
                    axios.post('/admin/sib/documents', { title: th.title, detail: th.editor.getData(), is_active: th.is_active })
                        .then((response) => {
                            th.loading = false;
                            th.documentId = response.data.id;
                            ...
                            if (callback) {
                                ...
                                location.href = '/admin/sib/documents';
                            }
            ...
            update: function (callback) {
                let th = this;
                th.loading = true;
                axios.put('/admin/sib/documents/'+th.documentId, { title: th.title, detail: th.editor.getData(), is_active: th.is_active })
                    .then((response) => {
                        th.loading = false;
                        th.title = response.data.title;
                        th.detail = response.data.detail;
            ...
            _removeFile: function (index) {
                ...
                if (confirm('Удалить?')) {
                    ...
                    axios.delete('/admin/sib/documents/'+th.documentId+'/files/'+th.list[index].id)
                        .then((response) => {
            ...
            _uploadFile: function () {
                ...
                if (file.files.length > 0) {
                    ...
                    axios.post('/admin/sib/documents/'+th.documentId+'/files', formData, {headers: {'Content-Type': 'multipart/form-data'}})
                        .then((response) => {
                            th.loading = false;
