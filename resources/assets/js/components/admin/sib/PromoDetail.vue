    ...
    <div class="events-detail-wrapper">
        ...
        <div class="tabs-left">
            ...
            <div class="text-center">
                ...
                <a href="/admin/sib/promos" class="btn btn-default">Отменить</a>
            </div>
        </div>
    </div>
</template>
        ...
        methods: {
            ...
            save: function (params, callback) {
                ...
                if (th.id) {
                    ...
                    axios.post('/admin/sib/promos', formData, {headers: {'Content-Type': 'multipart/form-data'}})
                        .then((response) => {
                            th.loading      = false;
                            ...
                            if (callback) {
                                ...
                                location.href = '/admin/sib/promos';
                            }
            ...
            update: function (callback) {
                ...
                axios.post('/admin/sib/promos/'+th.id, formData, {headers: {'Content-Type': 'multipart/form-data'}})
                    .then((response) => {
                        th.loading      = false;
                        th.title        = response.data.title;
                        th.announce     = response.data.announce;
            ...
            _removeFile: function (index) {
                ...
                if (confirm('Удалить?')) {
                    ...
                    axios.delete('/admin/sib/promos/'+th.id+'/files/'+th.list[index].id)
                        .then((response) => {
            ...
            _uploadFile: function () {
                ...
                if (file.files.length > 0) {
                    ...
                    axios.post('/admin/sib/promos/'+th.id+'/files', formData, {headers: {'Content-Type': 'multipart/form-data'}})
                        .then((response) => {
                            th.loading = false;
