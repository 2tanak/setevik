                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab2">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <h3 class="text-center text-success">
                                    <strong><i class="fa fa-check fa-lg"></i> Оплата подтверждена Куратором</strong>
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane active" id="tab3">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <p>
                                    ⠀⠀Ура, Куратор подтвердил оплату, Ты на финишной прямой. <br>
                                    ⠀⠀Осталось подождать пока Администратор активирует кабинет.
                                    Для этого в нашей Системе предусмотрено два <b>рабочих!!!</b> часа.<br>
                                </p>
                                <p>
                                    ⠀⠀В случае возникновения вопросов Ты можешь обращаться к своему Куратору,
                                    а также к Администратору системы:
                                </p>
...
<script>
    export default {
        name: "ActivationStep3",
        props: {
            activationData: Object,
        },
        mounted() {
            console.info('wizard:step 3');
