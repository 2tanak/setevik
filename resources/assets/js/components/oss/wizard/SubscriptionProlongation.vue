<template>
    <div :id="'modal-wizard-subscription-prolongation-'+product.id" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title">Продление абонемента</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <form novalidate="novalidate">
                            <div :id="'bootstrap-wizard-subscription-prolongation-'+product.id" class="col-sm-12">
                                <div class="form-bootstrapWizard">
                                    <ul class="bootstrapWizard form-wizard">
                                        <!-- #STEP 1 -->
                                        <template v-if="step == 1">
                                            <li data-target="#step1" class="active">
                                                <a href="#wizard-tab-subscription-prolongation-1" data-toggle="tab" class="hidden"></a>
                                                <span class="step">1</span>
                                                <span class="title">Оплата <br>(резидент)</span>
                                            </li>
                                            <li data-target="#step2">
                                                <a href="#wizard-tab-subscription-prolongation-2" data-toggle="tab" class="hidden"></a>
                                                <span class="step">2</span>
                                                <span class="title">Подтверждение <br>(активный куратор)</span>
                                            </li>
                                            <li data-target="#step3">
                                                <a href="#wizard-tab-subscription-prolongation-3" data-toggle="tab" class="hidden"></a>
                                ...
                                <div class="tab-content">
                                    ...
                                    <!-- #TAB1-->
                                    <div class="tab-pane" id="wizard-tab-subscription-prolongation-1" :class="{active: step == 1}">
                                        <br>
                                            ...
                                            <div class="col-xs-12">
                                                <div>
                                                    <p>
                                                        ...
                                                        имеющего действующий абонемент, и прикрепить квитанцию (скриншот) об оплате, нажав соответствующую кнопку ниже.</p>
                                                    <p>
                                                    ...
                                                    <p>
                                                        ⠀⠀Для завершения этого шага и перехода к следующему необходимо нажать кнопку «Далее».</p>
                                                </div>
                                                <div class="form-group">
                                                    <div class="checkbox">
                                                        ...
                                                        <template v-else>
                                                            <label>
                                                                <input type="file" name="quittance" id="subscription-prolongation-quittance" :disabled="isQuittanceSent">
                                    ...
                                    <!-- #TAB2-->
                                    <div class="tab-pane" id="wizard-tab-subscription-prolongation-2" :class="{active: step == 2}">
                                        <br>
                                        <h5><strong>Шаг 2: Подтверждение (куратор)</strong></h5>
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <p>⠀⠀Отлично. Теперь Твой вышестоящий Куратор должен произвести подтверждение Администратору
                                                    системы и после этого Ты автоматически перейдёшь к последнему шагу продления абонемента.</p>
                                    ...
                                    <!-- #TAB3-->
                                    <div class="tab-pane" id="wizard-tab-subscription-prolongation-3" :class="{active: step == 3}">
                                        <br>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <p>
                                                    ...
                                                    Для этого, как Ты знаешь, в нашей Системе предусмотрено два рабочих!!! часа.</p>
                                                <p>
    ...
    export default {
        ...
        methods: {
            init: function (product) {
                let th = this,
                    form = $('#modal-wizard-subscription-prolongation-'+th.product.id).find('form'),
                    wizardWrapper = $('#bootstrap-wizard-subscription-prolongation-'+th.product.id);
            ...
            sendQuittance: function () {
                let th = this,
                    ...
                    file = document.querySelector('#subscription-prolongation-quittance');
            ...
            show: function () {
                $('#modal-wizard-subscription-prolongation-'+this.product.id).modal('show');
            },
        }
    }
</script>
