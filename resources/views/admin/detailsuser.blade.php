...
{{--                                <p>6) Восстановите старый пароль <b>куратора</b></p>--}}
                        ...
                        <div class="col-md-12 text-center" style="padding-bottom: 30px;">
                            <div class="col-md-6 col-md-offset-4 text-center" style="padding-bottom: 30px;">
                                ...
                                {{--                                <div class="col-md-4 text-center">--}}
                                {{--                                    <h3>Восстановление профиля</h3>--}}
                                {{--                                    <p>--}}
                                {{--                                        Восстановление данных пользователя с локального хранилища, на случай неудачного слияния, или другого рода исключения.--}}
                                {{--                                    </p>--}}
                                {{--                                    <a href="javascript:void(0);"  onclick="restoreUserProfile()" class="btn txt-color-white bg-color-green btn-sm btn-block">Начать</a>--}}
                                {{--                                </div>--}}
                                <div class="col-md-4 text-center">
