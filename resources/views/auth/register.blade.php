...
@section('content')
                    ...
                    <div class="register-form">
                        ...
                        <form class="form-horizontal" id="register" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group-sm{{ $errors->has('birthday') ? ' has-error' : '' }}">
                                <input type="text" class="form-control datepicker date_first" readonly name="birthday" value="01.01.1980" placeholder="Дата рождения*">
                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                    ...
                    <div class="register-form">
                        ...
                        <form class="form-horizontal" id="register" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group-sm{{ $errors->has('birthday') ? ' has-error' : '' }}">
                                <input type="text" class="form-control datepicker date_second" name="birthday" readonly value="{{ old('birthday') }}" placeholder="Дата рождения*">
                                @if ($errors->has('birthday'))
                                    <span class="help-block">
                                    <small>{{ $errors->first('birthday') }}</small>
                                </span>
    ...
    <script>
        const today = moment();
        let date_first = document.getElementsByClassName('date_first')[0];
        let date_second = document.getElementsByClassName('date_second')[0];
        date_first.setAttribute('max', today.format('DD.MM.YYYY'));
        date_second.setAttribute('max', today.format('DD.MM.YYYY'));
    </script>
@endsection