    ...
    <div class="events-detail-wrapper">
                                ...
                                <div class="wrapper-form-input">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <p class="help-block">
                                                <i>Файл не должен превышать 20 MB</i>
                                            </p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="tabs-left">
            ...
            <div class="text-center">
                ...
                <a href="/admin/oss/news" class="btn btn-default">Отменить</a>
            </div>
        </div>
    </div>
</template>
        ...
        methods: {
            ...
            save: function (params, callback) {
                ...
                if (th.id) {
                    ...
                    axios.post('/admin/oss/news', formData, {headers: {'Content-Type': 'multipart/form-data'}})
                        .then((response) => {
            ...
            _uploadFile: function () {
                ...
                if (file.files.length > 0) {
                    ...
                    axios.post('/admin/oss/news/'+th.id+'/files', formData, {headers: {'Content-Type': 'multipart/form-data'}})
                        .then((response) => {
                            th.loading = false;
