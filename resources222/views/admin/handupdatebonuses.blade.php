                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4">
                            <form role="form">
                                ...
                                <a href="javascript:void(0);" type="submit" class="btn btn-primary" onclick="handUserBonusesUpdate()">Начислить</a>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function handUserBonusesUpdate() {
            ...
            if (binary_id.length > 0) {
                window.location.href = '/admin/handupdatebonusessuccess/'+binary_id;
            }
        }
    </script>
@endsection
