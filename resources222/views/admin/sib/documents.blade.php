            ...
            <div>
                ...
                <div class="widget-body">
                    ...
                    <table class="table table-striped table-forum" style="margin-bottom: auto">
                        <thead>
                            <tr>
                                <th colspan="2" class="hidden-xs hidden-sm text-center">Наименование</th>
                                <th class="hidden-xs hidden-sm text-center" style="width: 200px;">Дата размещения</th>
                                <th class="hidden-xs hidden-sm text-center" style="width: 200px;">Количество файлов</th>
                            </tr>
                        </thead>
                        <tbody>
