            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                    <div class="auth-register-logo">
                        <img src="{{ asset('img/logo-oss.png') }}" class="img-responsive" style="width: 50%" alt="logo">
                    </div>
                    <div class="register-form">
                        ...
                        <form class="form-horizontal" id="register" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group-sm{{ $errors->has('email') ? ' has-error' : '' }}">
                                <input type="email" class="form-control" name="email" value="user{{ $userCount + 1 }}@example.com" placeholder="E-mail*" autofocus>
